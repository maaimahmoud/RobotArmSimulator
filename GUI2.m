...
z=' degree';
    ...
    set(handles.text4,'string',strcat(num2str (l1*cosd(q1)+l2*cosd(q1+q2)+l3*cosd(q1+q2+q3)),x));
    set(handles.text5,'string',strcat(num2str (l1*sind(q1)+l2*sind(q1+q2)+l3*sind(q1+q2+q3)),y));
    set(handles.text6,'string',strcat(num2str (mod((q1+q2+q3+360),360)),z));
else
    msgbox('No Solution');
end
...
if (((q1 <= R1max && q1 >= R1min) || R1min == R1max) && (( q2 <= R2max && q2 >= R2min) || R2min == R2max) && ((q3 <= R3max && q3 >= R3min) || R3min == R3max))
    ...
    set(handles.text4,'string',strcat(num2str (q11),x));
    set(handles.text5,'string',strcat(num2str (q22),y));
    set(handles.text6,'string',strcat(num2str (q33),z));
...
elseif (((q1_ <= R1max && q1_ >= R1min)|| R1min == R1max) && ((q2_ <= R2max &&q2_ >= R2min)|| R2min == R2max) && ((q3_ <= R3max && q3_ >= R3min)|| R3min == R3max))
    ...
    set(handles.text2,'string','q2');
    set(handles.text3,'string','q3');
    set(handles.text4,'string',strcat(num2str (q11_),x));
    set(handles.text5,'string',strcat(num2str (q22_),y));
    set(handles.text6,'string',strcat(num2str (q33_),z));
    set(handles.pushbutton5, 'Enable', 'off');
else
    msgbox('out of range');
end
...
set(handles.text4,'string',strcat(num2str (Q1max),x));
set(handles.text5,'string',strcat(num2str (Q2max),y));
set(handles.text6,'string',strcat(num2str (Q3max),z));
